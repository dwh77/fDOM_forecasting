...
dfold <- arrow::open_dataset(old_met_bucket) |>
  filter(site_id == "fcre",
         variable %in% c("surface_downwelling_shortwave_flux_in_air"),
         # parameter <= 2
         ) |>  ## call dplyr functions here to reduce data size
  dplyr::collect()

head(dfold)
#average to daily forecasts
...
# test <- arrow::open_dataset("s3://anonymous@bio230121-bucket01/vt_backup/drivers/noaa/gefs-v12-reprocess/stage2?endpoint_override=renc.osn.xsede.org") 
# 
# # |> 
# #   filter(#datetime >= ymd_hms("2024-01-01 00:00:00"), datetime <= ymd_hms("2024-01-31 23:00:00"),
# #          site_id == 'fcre',
