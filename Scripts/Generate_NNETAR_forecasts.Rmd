...
#reomve uneeded variables after getting data toghether
...
# dir.create("../Data/NNETAR_4casts/fcre")
# dir.create("../Data/NNETAR_4casts/bvre")
# dir.create("../Data/NNETAR_4casts/ccre")
...
for (j in 1:length(forecast_date)) {
  ...
  # fdom_nnetar(forecast_date = forecast_date[j], targets_df = targets_df, site = site, depth = depth,
  #             var = var,
  #             forecast_horizon = 16, output_folder = output_folder)
