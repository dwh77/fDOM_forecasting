...
rmsefig_allyear_AR <- AR_clim_nnetar_persist_outputs_observed |> 
  ...
  summarise(AR = round(sqrt(mean((mu_AR - observation)^2, na.rm = TRUE)), 2),
            ...
            ML = round(sqrt(mean((mu_NNETAR - observation)^2, na.rm = TRUE)), 2),
...
ggsave(filename = "C:/Users/dwh18/OneDrive/Desktop/R_Projects/fDOM_forecasting/Data/ASLO_talk_forecast_output/rmse_ar_allyear.jpg",
...
ggsave(filename = "C:/Users/dwh18/OneDrive/Desktop/R_Projects/fDOM_forecasting/Data/ASLO_talk_forecast_output/rmse_allmodel_allyear.jpg",
...
rmse_season_full <- AR_clim_nnetar_persist_outputs_observed |> 
  ...
  pivot_longer(-c(1:3)) |> 
  rename(model = name) |> 
  ggplot(aes(x = Horizon, y = value, color = model, shape = Season))+
  geom_line(linewidth = 1.2)+
  geom_point(size = 3)+
  ...
  labs(x = "Horizon", y = "RMSE (QSU)")+
    ylim(0,3.2)+
  theme_bw() + theme(legend.position = "top", text = element_text(size = 14))+
   scale_color_manual(values = c("AR" = "#F8766D", "Persist"= "#F564E3"))  # NNETAR = #00BFC4 , Clim = #00BA38


ggsave(filename = "C:/Users/dwh18/OneDrive/Desktop/R_Projects/fDOM_forecasting/Data/ASLO_talk_forecast_output/rmse_sseasons_ar_persist.jpg",
...
ggsave(filename = "C:/Users/dwh18/OneDrive/Desktop/R_Projects/fDOM_forecasting/Data/ASLO_talk_forecast_output/rmse_ssummer_ar_persist.jpg",
...
ggsave(filename = "C:/Users/dwh18/OneDrive/Desktop/R_Projects/fDOM_forecasting/Data/ASLO_talk_forecast_output/pre_4cast_fig.jpg",
...
ggsave(filename = "C:/Users/dwh18/OneDrive/Desktop/R_Projects/fDOM_forecasting/Data/ASLO_talk_forecast_output/ar_4cast_fig.jpg",
...
ggsave(filename = "C:/Users/dwh18/OneDrive/Desktop/R_Projects/fDOM_forecasting/Data/ASLO_talk_forecast_output/all_4cast_fig.jpg",
...
ggsave(filename = "C:/Users/dwh18/OneDrive/Desktop/R_Projects/fDOM_forecasting/Data/ASLO_talk_forecast_output/all_4cast_fig_withobs.jpg",
