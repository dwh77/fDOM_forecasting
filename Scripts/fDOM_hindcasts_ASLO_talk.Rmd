...
return(write.csv(forecast_full_unc, file = paste0("C:/Users/dwh18/OneDrive/Desktop/R_Projects/fDOM_forecasting/Data/ASLO_talk_forecast_output/", output_folder, "/forecast_full_unc_", forecast_date, '.csv')))
...
# Days look broke: 5dec22, 19feb24,
...
fcr_output_all <- list.files(path = "C:/Users/dwh18/OneDrive/Desktop/R_Projects/fDOM_forecasting/Data/ASLO_talk_forecast_output/fcre_run30apr24", pattern = "*.csv", full.names = T) |> 
...
pdf("C:/Users/dwh18/OneDrive/Desktop/R_Projects/fDOM_forecasting/Data/ASLO_talk_forecast_output/fcre_run30apr24/all_forecasts_3.pdf", height = 250)

fcr_output_all |> 
  # mutate(Horizon = Horizon*-1) |> 
   #filter(reference_datetime == ymd("2023-01-05")) |> 
  ggplot(aes(x = Horizon, y = value, color = as.character(ensemble_member)))+ #, color = as.character(ensemble_member)
  geom_line()+
...
output_stats <- left_join(fcr_output_all, fcr_fdom, by = c("date" = "datetime")) |> 
