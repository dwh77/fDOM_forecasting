...
return(write.csv(forecast_df, file = paste0("C:/Users/dwh18/OneDrive/Desktop/R_Projects/fDOM_forecasting/Data/ASLO_talk_forecast_output/", output_folder, "/forecast_full_unc_", forecast_date, '.csv')))
...
generate_baseline_climatology <- function(targets, # a dataframe already read in
  ...
  if (nrow(target_clim) == 0) {
    ...
    if (length(site_count) != 0) {
      ...
      # return(combined)
      return(write.csv(combined, file = paste0("C:/Users/dwh18/OneDrive/Desktop/R_Projects/fDOM_forecasting/Data/ASLO_talk_forecast_output/", output_folder, "/forecast_climatology_", forecast_date, '.csv')))
