...
fdom_TS <- targets |> 
  ...
  ggplot(aes(x = datetime, y = observation, color = site_id_A))+
   # geom_rect(aes(xmin = ymd("2023-03-13"), xmax = ymd("2024-03-01"), ymin = -Inf, ymax = Inf), 
   #           alpha = 0.01, fill = "gray", color = NA )+ 
  geom_vline(xintercept = ymd("2024-03-01"), linetype = 2, linewidth = 1.2)+
    annotate("text", x = as.Date("2023-08-15"), y = 28, label = "Calibration", color = "black", size = 4, fontface = "bold")+
    annotate("text", x = as.Date("2024-05-15"), y = 28, label = "Forecasting", color = "black", size = 4, fontface = "bold")+
  geom_point()+
