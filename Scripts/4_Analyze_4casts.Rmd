...
Scored_forecasts <- read_csv("../Data/allReservoir_allmodel_4cast_Scores_30jan25.csv") |> 
  ...
  #        reference_datetime <= ymd("2024-08-01")) |> 
    filter(reference_datetime >= ymd("2023-12-01"),
         reference_datetime <= ymd("2024-11-30")) |>
...
#ggsave("../Figures/rmse_season_MS.png", rmse_season_v2, height = 5.5, width = 6.5, units = "in")
...
## Summary stats 
targets |> 
    filter(datetime >= ymd("2023-12-01"),
         datetime < ymd("2024-12-01")
         ) |> 
  group_by(site_id) |> 
