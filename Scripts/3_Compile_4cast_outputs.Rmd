...
```{r}
#AR
allres_AR <- read.csv("../Data/Forecast_Outputs/AR_4casts/allReservoir_AR_4cast.csv")

#NNAR
allRes_NNETAR_output_all <- read.csv("../Data/Forecast_Outputs/NNETAR_4casts/allReservoir_NNETAR_4cast.csv")

#Met Regress
allres_MetRegress <- read.csv("../Data/Forecast_Outputs/MetRegress_4casts/allReservoir_MetRegress_4cast.csv")

#Rain lag
allres_RainLag <- read.csv("../Data/Forecast_Outputs/RainLag_4casts/allReservoir_RainLag_4cast.csv")

#Clim
allres_Clim <- read.csv("../Data/Forecast_Outputs/Clim_4casts/allReservoir_Clim_4cast.csv")

#Persist
allres_Persist <- read.csv("../Data/Forecast_Outputs/Persist_4casts/allReservoir_Persist_4cast.csv")
...
write.csv(All_Scores, "../Data/allReservoir_allmodel_4cast_Scores_27mar25.csv", row.names = F)
