...
return(write.csv(forecast_full_unc, file = paste0("./ASLO_forecast_output/forecast_full_unc_", forecast_start_date, '.csv'))
)
...
for (j in 2:length(forecast_start_date)) {
  ...
  fdom_forecast(variable, forecast_start_date[j], 
...
works: try adding all uncert sources
