...
return(write.csv(forecast_full_unc, file = paste0("./ASLO_forecast_output/20feb24_1154am/forecast_full_unc_", forecast_start_date, '.csv'))
)
...
output_stats |> 
  ggplot()+
  geom_boxplot(aes(x = as.factor(Horizon), y = resid, color = Season))+
  # geom_jitter()+
  ggtitle("residual by season")+
  theme_bw()
